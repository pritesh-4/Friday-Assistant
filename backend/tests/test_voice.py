...
def mock_orchestrator():
    with patch("app.services.voice.orchestrator.VoiceOrchestrator.process_conversation") as mock:
        mock.return_value = {
            "transcript": "Hello world",
...
def mock_orchestrator_stream():
    ...
    with patch("app.services.voice.orchestrator.VoiceOrchestrator.stream_conversation") as mock:
